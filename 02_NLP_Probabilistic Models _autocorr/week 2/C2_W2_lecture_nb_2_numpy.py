...
# Set the print options for numpy to display numbers with 2 decimal places
np.set_printoptions(precision=0, suppress=True, formatter={'float_kind': '{:0.0f}'.format})
